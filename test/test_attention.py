...
class TestAttention(unittest.TestCase):
    ...
    def test_masking(self):
        ...
        q = self.attention._split_heads(self.attention.to_q(x), self.heads)
        k = self.attention._split_heads(self.attention.to_k(x), self.heads)
